...
public class VariableEX1 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// 변수 선언 : 메모리에 값을 저장할 공간을 만든다(== 할당한다)
		
		int num1;	// 메모리에 int형 데이터를 저항하기 위한 공간(4byte)를 할당하고
					// 변수 이름을 num1이라고 지정
		...
		// int 초과값 대입 -> 오류발생
		//int intnum2 = 2147483648;	// int 최대값
		...
		// -> floatnum에 값을 저장할 수없다
		
		// 실수 기본형 : double
		// (1.26처럼) 보통 실수표기법이 double로 인식됨
		...
		/* float (4byte)
		 * double(8byte)
		 * byte 크기가 2배여서 double이 아님.
		 * 정확도가 2배여서, 소수점 자릿수가 2배라서 double
		 */
		...
		String str1 = "문자열 리터럴 표기법은 쌍따옴표를 씌워서 적어야 합니다.";
		String str2 = "String은 주소를 저장하고 찾으러가는 참조형 입니다.";
